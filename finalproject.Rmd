...
```{r echo=FALSE}
p1=ggplot(insurance2, aes(age, charges)) + geom_point(size=0.5, color = 'red') 
p2=ggplot(insurance2, aes(as.factor(sex), charges)) + geom_boxplot(outlier.size=0.5, color = 'orange')
p3=ggplot(insurance2, aes(bmi, charges)) + geom_point(size=0.5, color = 'yellow')
p4=ggplot(insurance2, aes(as.factor(children), charges)) + geom_boxplot(outlier.size=0.5, color = 'green')
p5=ggplot(insurance2, aes(as.factor(smoker), charges)) + geom_boxplot(outlier.size=0.5, color = 'blue')
p6=ggplot(insurance2, aes(as.factor(region), charges)) + geom_boxplot(outlier.size=0.5, color = 'purple') + theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
```{r echo=FALSE}
p_int1=ggplot(insurance2, aes(x = paste(sex, smoker), y = charges)) + geom_boxplot(outlier.size=0.5, color = 'purple') + theme(axis.text.x = element_text(angle = 45, hjust = 1)) + theme(aspect.ratio=1)
p_int2=ggplot(insurance2, aes(x = paste(sex, region), y = charges)) + geom_boxplot(outlier.size=0.5, color = 'brown') + theme(axis.text.x = element_text(angle = 45, hjust = 1)) + theme(aspect.ratio=1)
p_int3=ggplot(insurance2, aes(x = paste(region, smoker), y = charges)) + geom_boxplot(outlier.size=0.5, color = 'darkblue') + theme(axis.text.x = element_text(angle = 45, hjust = 1)) + theme(aspect.ratio=1)
...
mod4_plot = ggplot(insurance2, aes(age, charges)) + geom_point(size=0.5, color = 'purple') + 
...
mod5_plot = ggplot(insurance2, aes(bmi, charges)) + geom_point(size=0.5, color = 'green') + 
...
mod6_plot = ggplot(insurance2, aes(children, charges)) + geom_point(size=0.5, color = 'blue') + 
