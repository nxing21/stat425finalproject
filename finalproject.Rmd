...
```{r echo=FALSE}
knitr::kable(sort(abs(stud), decreasing=TRUE)[1:5], col.names = c("Observation Number", "Studentized Residual")) # largest 5 studentized residuals
...
knitr::kable(broom::tidy((model_lm)))
...
knitr::kable(head(compare_results))
```
